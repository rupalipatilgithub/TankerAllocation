...
public class ApprovedStatus extends Fragment {
    ...
    private ArrayList<Approved> approvedStatusList;
                                ...
                                for (int i = 0; i < respObj.length(); i++) {
                                    ...
                                    if (jsonObject.getString("status").
                                       ...
                                       // approved.setPlot_no(jsonObject.getString("plot_no"));
                                        ...
                                        approvedStatusList.add(approved);
                                    }


                                }

                                ApprovedAdapter pendingAdapter = new ApprovedAdapter(getActivity(), approvedStatusList);
