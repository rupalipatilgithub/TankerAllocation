package com.example.tankerallocation.Model;
...
public class Approved implements Serializable {
    ...
    public String getDrivermob_no() {
        return drivermob_no;
    }

    public void setDrivermob_no(String drivermob_no) {
        this.drivermob_no = drivermob_no;
    }
    ...
    public void setTanker_no(String tanker_no) {
        Tanker_no = tanker_no;
    }
